...
const Login = () => {
    ...
    <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
        ...
        <a href="#" className="flex items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transhtmlForm border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
        ...
        <div className="flex items-center justify-between mt-4">
            ...
            <Link to={'/register'}><a href="#" className="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">or register</a></Link>
