                        ...
                        <div className="mt-8 lg:w-1/2 lg:px-6 lg:mt-0">
                            ...
                            <form className="max-w-md mt-10 mx-auto">
...

                                {
                                    ...
                                    <button type="button" disabled  className="text-white  bg-blue-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">Approved</button>
