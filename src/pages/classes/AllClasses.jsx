...
const AllClasses = () => {
    ...
    // Filter class groups based on search query
    const filteredClassGroups = Object.keys(classGroups).filter(className =>
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 justify-center items-center">
                {filteredClassGroups.map((className) => (
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-10 justify-center mt-24">
                {upcoming.map(up => (
                    <div key={up._id} className="max-w-lg p-4 shadow-md dark:bg-gray-50 dark:text-gray-800">
