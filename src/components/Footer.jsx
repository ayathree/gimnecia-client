    ...
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
                  ...
                  <span className="self-center text-3xl font-extrabold text-gray-500 whitespace-nowrap dark:text-white">GYMNECIA</span>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="" className="hover:underline">GYMNECIA</a>. All Rights Reserved.
          </span>
